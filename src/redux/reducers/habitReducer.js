...
export const habitSlice = createSlice({
    ...
    reducers: {
        ...
        addHabit: (state, action) => {
            ...
            state.habits.push({
                id: id++,
                name: action.payload, //Name of the habit,passed in the action payload
        ...
        habitDone: (state, action) => {
            //Mapping over the habits array 
            state.habits.map((habit, i) => {
                //Check if its id matches with the id stored in localStorage
                if (habit.id === Number(localStorage.getItem("id"))) {
                    // Mark the specific day in the week log as done (true)
        ...
        habitUnDone: (state, action) => {
            ...
            state.habits.map((habit, i) => {
                if (habit.id === Number(localStorage.getItem("id"))) {
                    // Mark the specific day in the week log as undone (false)
        ...
        habitNone: (state, action) => {
            state.habits.map((habit, i) => {
                if (habit.id === Number(localStorage.getItem("id"))) {
                     // Reset the status of the specific day in the week log to an empty string
